...
class TomoScanBEATSPcoAcsCont(TomoScanCont):
    ...
    def systemInitializations(self):
        ...
        self.epics_pvs['CamNDAttributesFile'].put(self.pvlist['XMLFiles']['detectorAttributes']['PcoAcsContAttr'])
        self.epics_pvs['FPXMLFileName'].put(self.pvlist['XMLFiles']['layout']['PcoAcsContLayout'])
    ...
    def begin_scan(self):
        ...
        stopCommand = [scriptsPath + 'BEATS_GUI_Bash_Stop', '--process', 'PCO_WriterServerCont']
        startCommand = [scriptsPath + 'BEATS_GUI_Bash_Start', '--process', 'PCO_WriterServerCont']
        xtermCommandStart = [scriptsPath + 'writer_pco_cont_start.sh']
        xtermCommandStop = [scriptsPath + 'writer_pco_cont_stop.sh']
        try:
