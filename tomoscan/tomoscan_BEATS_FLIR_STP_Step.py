...
class TomoScanBEATSFlirStpStep(TomoScanSTEP):
    ...
    def __init__(self, pv_files, macros):
        ...
        self.epics_pvs['CamNDAttributesFile'].put('ADZMQ_BEATS_STEP_DetectorAttributes.xml')
        self.epics_pvs['FPXMLFileName'].put('ADZMQ_BEATS_STEP_Layout.xml')
