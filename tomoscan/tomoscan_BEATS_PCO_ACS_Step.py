...
class TomoScanBEATSPcoAcsStep(TomoScanSTEP):
    ...
    def systemInitializations(self):
        ...
        self.epics_pvs['CamNDAttributesFile'].put(self.pvlist['XMLFiles']['detectorAttributes']['PcoAcsStepAttr'])
        self.epics_pvs['FPXMLFileName'].put(self.pvlist['XMLFiles']['layout']['PcoAcsStepLayout'])
