...
class TomoScanBEATSFlirAcsCont(TomoScanCont):
    ...
    def systemInitializations(self):
        ...
        self.epics_pvs['CamNDAttributesFile'].put(self.pvlist['XMLFiles']['detectorAttributes']['FlirAcsContAttr'])
        self.epics_pvs['FPXMLFileName'].put(self.pvlist['XMLFiles']['layout']['FlirAcsContLayout'])
