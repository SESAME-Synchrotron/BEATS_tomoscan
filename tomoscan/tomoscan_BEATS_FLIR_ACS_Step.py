...
class TomoScanBEATSFlirAcsStep(TomoScanSTEP):
    ...
    def systemInitializations(self):
        ...
        self.epics_pvs['CamNDAttributesFile'].put(self.pvlist['XMLFiles']['detectorAttributes']['FlirAcsStepAttr'])
        self.epics_pvs['FPXMLFileName'].put(self.pvlist['XMLFiles']['layout']['FlirAcsStepLayout'])
