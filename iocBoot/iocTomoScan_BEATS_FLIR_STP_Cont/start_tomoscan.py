...
from tomoscan.tomoscan_BEATS_FLIR_STP_Cont import TomoScanBEATSFlirStpCont
ts = TomoScanBEATSFlirStpCont(["../../db/tomoScan_settings.req",
                  "../../db/tomoScan_BEATS_FLIR_STP_Cont_settings.req"], 
                 {"$(P)":"tomoscanBEATS:", "$(R)":"FlirStpCont:"})
